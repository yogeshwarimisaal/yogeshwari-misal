...
import { AVATAR_COLORS, COLORS } from '../utils/constants'
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div>
          ...
          <div style={styles.cafeSubtitle}>
            {lang === 'mr' ? 'स्टाफ चेक-इन' : 'Staff Check-in'}
          </div>
        </div>
      ...
      <div style={styles.orderButtonsRow}>
        <a href="/quick" style={styles.quickBtn}>
          <div style={styles.btnTitle}>
            {lang === 'mr' ? '⚡ झटपट ऑर्डर' : '⚡ Quick Order'}
          </div>
          <div style={styles.btnSub}>
            {lang === 'mr' ? 'ऑर्डर + पेमेंट एकत्र' : 'Order + Pay together'}
          </div>
        </a>
        <a href="/pos" style={styles.posBtn}>
          <div style={styles.btnTitle}>
            {lang === 'mr' ? '🪑 टेबल ऑर्डर' : '🪑 Table Order'}
          </div>
          <div style={styles.btnSub}>
            {lang === 'mr' ? 'अनेक टेबल एकत्र' : 'Manage multiple tables'}
          </div>
        </a>
      </div>
